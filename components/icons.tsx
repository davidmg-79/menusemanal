...
export const RefreshIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className || "h-6 w-6"} fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 4v5h5M20 20v-5h-5M4 4l1.5 1.5A9 9 0 0120 10M20 20l-1.5-1.5A9 9 0 004 14" />
    </svg>
);
...
export const ChefHatIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className || "h-8 w-8"} viewBox="0 0 24 24" fill="currentColor">
        <path d="M12 2C8.69 2 6 4.69 6 8H18C18 4.69 15.31 2 12 2ZM5 9C4.45 9 4 9.45 4 10V11H20V10C20 9.45 19.55 9 19 9H5ZM4 12V20C4 21.1 4.9 22 6 22H18C19.1 22 20 21.1 20 20V12H4Z" />
    </svg>
);
...
export const CheckboxCheckedIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className || "h-6 w-6"} fill="currentColor" viewBox="0 0 24 24">
        <path d="M18.3,4.22a2,2,0,0,0-2.83,0L9,10.69,7.53,9.22a2,2,0,0,0-2.83,2.83l3,3a2,2,0,0,0,2.83,0l8.78-8.78A2,2,0,0,0,18.3,4.22Z" />
        <path d="M19,1.07H5A4,4,0,0,0,1,5V19a4,4,0,0,0,4,4H19a4,4,0,0,0,4-4V5A4,4,0,0,0,19,1.07Zm2,18a2,2,0,0,1-2,2H5a2,2,0,0,1-2-2V5A2,2,0,0,1,5,3H19a2,2,0,0,1,2,2Z" />
    </svg>
);
...
export const BookOpenIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className || "h-6 w-6"} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        ...
        <path strokeLinecap="round" strokeLinejoin="round" d="M6.5 2H20v15H6.5A2.5 2.5 0 014 14.5v-10A2.5 2.5 0 016.5 2z" />
    </svg>
);
...
export const SpeedometerIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className || "h-6 w-6"} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 8c-3.314 0-6 2.686-6 6s2.686 6 6 6 6-2.686 6-6-2.686-6-6-6z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 8V6" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M16.95 9.05l1.414-1.414" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 14l-2.05-2.05" />
    </svg>
);
